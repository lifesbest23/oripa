 ...
 *
 */
public class ChangeOnEditBGImageButtonSelected implements ChangeViewSetting {
	private final UIPanelSetting setting;

	/**
	 * Constructor
	 */
	public ChangeOnEditBGImageButtonSelected(final UIPanelSetting uiPanelSetting) {
